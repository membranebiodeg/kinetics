...
% initial guess
varb(1) = 1110; % theoretical CO2 production
varb(2) = 21; % maximum value of weight loss rate or CO2 production rate
varb(3) = 20; % time rate constant of the process
...
legend('Experimental (28°C)','Modified Gompertz (28°C)')
